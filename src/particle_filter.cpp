...
// void ParticleFilter::init(double std_position[], double std_orient[]) {
    ...
    uniform_real_distribution<double> dist_roll(-M_PI, M_PI);
    uniform_real_distribution<double> dist_pitch(-M_PI, M_PI);
...
void ParticleFilter::resample() {
    ...
    for (int i = 0; i < num_particles; i++){
        ...
        normal_distribution<double> dist_r(resampled_one.roll, std_orient[0]);
        normal_distribution<double> dist_p(resampled_one.pitch, std_orient[1]);
        ...
        resampled_one.R = rotationMatrixFromEuler(resampled_one.roll, resampled_one.pitch, resampled_one.yaw);
...
//         cout << "Roll test: " << rotationMatrixToEuler(particle.R)[0] << endl;
